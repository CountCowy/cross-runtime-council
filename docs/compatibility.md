...
| Claude Code | Session-authenticated MCP adapter + live child relay | Same 2026-08-24 live matrix passed with Claude Code 2.1.241 (desktop app 1.34493.1). Registration steps verified against a working install, not yet clean-room rehearsed. |
